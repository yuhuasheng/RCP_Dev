...
public class MNTEditingSupport extends EditingSupport {
	...
	public MNTEditingSupport(ColumnViewer viewer, int index, TreeTools treeTools) {
		super(viewer);
	...
	protected void setValue(Object obj, Object obj1) {
		...
		// 更新属性值到Tree绑定的实体类中
//		MNTTreePropertiesTools.updateProperties(propertiesInfo, index, value);
		// 同步结构树中的模型数据
		treeTools.syncTreeModelData(topBomInfo, currentInfo, index, value, BUConstant.MNTBUNAME);
		// 刷新结构树中类型为料号对象的属性
