...
public class DCNMTAssignPropertyBean extends AbstractPropertyBean<Object> {
	...
	public DCNMTAssignPropertyBean() {
		super();
		System.out.println("Customer 1");
		
	}

	public DCNMTAssignPropertyBean(Control paramControl) {
		super(paramControl);
	}

	public DCNMTAssignPropertyBean(FormToolkit paramFormToolkit, Composite paramComposite, boolean paramBoolean,
				...
				Display.getDefault().syncExec(new Runnable() {
					...
					public void run() {	
						...
						if (TCUtil.isNull(map)) {
							...
							String id = "DCN-"+(map.get("id") == null ? "" : map.get("id").toString().trim());
							text.setText(id);
						}
					}
				});
