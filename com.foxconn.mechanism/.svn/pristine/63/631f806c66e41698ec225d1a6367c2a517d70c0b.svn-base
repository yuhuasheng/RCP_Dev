...
public class DTMISCDataModel implements DTDataModel {
	...
	@TCPropertes(tcProperty = "bl_quantity", tcType = "BOMLine", cell = 9)
	private String usage = "1";
	
	@TCPropertes(tcProperty = "d9_Material", cell = 10)
	private String material;

	@TCPropertes(tcProperty = "d9_Adhesive", cell = 11)
	...
	@TCPropertes(tcProperty = "", cell = 15)
