...
public class CustomerImpactDellLovPropertyBean extends AbstractPropertyBean<Object> {
	...
	public CustomerImpactDellLovPropertyBean() {
		super();
		System.out.println("CustomerImpactDellLovPropertyBean");
	}

	public CustomerImpactDellLovPropertyBean(Control paramControl) {
		super(paramControl);
		
	}

	public CustomerImpactDellLovPropertyBean(FormToolkit paramFormToolkit, Composite paramComposite, boolean paramBoolean,
			Map<?, ?> paramMap) {
		System.out.println("==>> CustomerImpactDellLovPropertyBean 构造方法");
	...
	private void addListener() {
		combo.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				System.out.println("==>> Customer Impact Dell Combo Select value is : " + text);
				...
				if (CommonTools.isNotEmpty(productImpactValue) && CommonTools.isNotEmpty(text) && CommonTools.isNotEmpty(likelihoodValue)) {
					if (ProductImpactLovPropertyBean.checkSpecChar(productImpactValue) && ProductImpactLovPropertyBean.checkSpecChar(text) 
	...
	public void load(TCProperty paramTCProperty) throws Exception {
		System.out.println("CustomerImpactDellLovPropertyBean load TCProperty");
	...
	public void load(TCPropertyDescriptor paramTCPropertyDescriptor) throws Exception {
		System.out.println("==>> CustomerImpactDellLovPropertyBean TCPropertyDescriptor");	
	...
	public static void setCombo(Combo combo) {
		CustomerImpactDellLovPropertyBean.combo = combo;
	}
