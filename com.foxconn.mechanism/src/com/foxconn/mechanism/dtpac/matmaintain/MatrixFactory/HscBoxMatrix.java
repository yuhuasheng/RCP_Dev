 ...
 *
 */
public class HscBoxMatrix implements MatrixInterfance{
	private ExcelBean bean;
	
	public HscBoxMatrix(){}
	
	public HscBoxMatrix(ExcelBean bean){
		this.bean = bean;
	}
	...
	public void calculateCost() {
		...
		BigDecimal num2 = NumberUtil.add(this.bean.getHeight() , NumberUtil.div(this.bean.getWidth(), "2").toString());
