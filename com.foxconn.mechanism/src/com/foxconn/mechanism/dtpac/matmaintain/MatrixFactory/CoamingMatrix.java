 ...
 *
 */
public class CoamingMatrix implements MatrixInterfance{
	private ExcelBean bean;
	
	public CoamingMatrix(){}
	
	public CoamingMatrix(ExcelBean bean){
		this.bean = bean;
	}
	...
	public void calculateCost() {
		...
		double price = NumberUtil.div(NumberUtil.mul(num1.toString(),this.bean.getHeight()).doubleValue() * 2 , 1000000D);
