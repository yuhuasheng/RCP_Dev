 ...
 *
 */
public class PartitionMatrix implements MatrixInterfance{
	private ExcelBean bean;
	
	public PartitionMatrix(){}
	
	public PartitionMatrix(ExcelBean bean){
		this.bean = bean;
	}
	...
	public void calculateCost() {
		...
		double price = NumberUtil.div(NumberUtil.mul(num2.toString(),this.bean.getDensity()).doubleValue() , 1000000000D);
