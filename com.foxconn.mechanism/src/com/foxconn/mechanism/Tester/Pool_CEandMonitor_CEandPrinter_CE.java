...
public class Pool_CEandMonitor_CEandPrinter_CE extends PropertyTester {
	@Override
	public boolean test(Object arg0, String arg1, Object[] arg2, Object arg3) {
		...
		try {
			...
			if( full_name.contains("CE.CTC RD Pool.R&D.Desktop.D_Group") || full_name.contains("CE.R&D.Monitor.D_Group") 
					|| full_name.contains("CE.R&D.Printer.D_Group") || full_name.equals("dba") )
				{
					return true;
				}
		} catch (TCException e) {
