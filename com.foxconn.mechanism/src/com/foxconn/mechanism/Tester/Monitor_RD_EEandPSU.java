...
public class Monitor_RD_EEandPSU extends PropertyTester {
	@Override
	public boolean test(Object arg0, String arg1, Object[] arg2, Object arg3) {
		...
		try {
			...
			if( full_name.contains("EE.R&D.Monitor.D_Group") ||  full_name.equals("PSU.R&D.Monitor.D_Group") || full_name.equals("dba"))
			{
				return true;
			}
		} catch (TCException e) {
