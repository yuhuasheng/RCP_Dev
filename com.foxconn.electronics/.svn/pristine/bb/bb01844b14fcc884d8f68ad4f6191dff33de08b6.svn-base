...
public class IssueUpdatesService {
	...
	private IssueUpdatesDialog dialog;
	
	public IssueUpdatesService(TCSession session, String customer,TCComponentItemRevision itemRevision,IssueUpdatesDialog dialog) {
		super();
