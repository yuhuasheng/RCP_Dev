...
public class CreateIssueController {
	...
	public CreateIssueController(TCSession session,ResourceBundle reg,String customer,CreateIssueDialog dialog) {
		super();
		this.service = new CreateIssueService(session,reg,customer,dialog);
	}
