...
public class PowerNewBOMRowBean implements EBOMApplyRowBean {
	...
	@TCPropertes(tcProperty = "d9_IsNewPCBA", cell = 3, required = true, columnName = "PCBA是否新建")
	private String isNewPCBA;
	
	@TCPropertes(tcProperty = "d9_Name", cell = 4, required = false, columnName = "品名")
	private String name;
	
	@TCPropertes(tcProperty = "d9_SemiPN", cell = 5, required = false, columnName = "半成品料號")
