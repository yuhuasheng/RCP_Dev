...
public class EE3DDrawCountReportDialog  extends Dialog{
	
	private String url;
	private Registry reg;
	private Shell shell = null;
	
	public EE3DDrawCountReportDialog (Shell parentShell, String url) {
		super(parentShell);
		this.url = url;
		shell = new Shell(shell,SWT.DIALOG_TRIM | SWT.MAX | SWT.RESIZE | SWT.CLOSE | SWT.PRIMARY_MODAL | SWT.MIN);
        this.reg = Registry.getRegistry("com.foxconn.electronics.ee3dDrawCountReport.ee3dDrawCountReport");
	}
