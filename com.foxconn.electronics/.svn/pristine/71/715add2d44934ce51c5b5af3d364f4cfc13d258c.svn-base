...
public class Desktop_MFDandMonitor_MEandPrinter_ME extends PropertyTester {
	@Override
	public boolean test(Object arg0, String arg1, Object[] arg2, Object arg3) {
		try {
			...
			if( full_name.contains("MFD.R&D.Desktop.D_Group") || full_name.contains("ME.R&D.Monitor.D_Group")
					|| full_name.contains("ME.R&D.Printer.D_Group") || full_name.equals("dba"))
			{
				return true;
			}
