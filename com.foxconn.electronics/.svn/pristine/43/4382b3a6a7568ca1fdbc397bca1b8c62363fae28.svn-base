...
public class CreateIssueDialog extends Dialog{
	...
	public CreateIssueDialog (Shell parentShell, Dimension dim, TCSession session, String url,ResourceBundle reg) {
		super(parentShell);
