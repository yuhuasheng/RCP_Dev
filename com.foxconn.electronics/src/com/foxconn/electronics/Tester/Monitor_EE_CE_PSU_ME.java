...
public class Monitor_EE_CE_PSU_ME extends PropertyTester {
	@Override
	public boolean test(Object arg0, String arg1, Object[] arg2, Object arg3) {
		...
		try {
			...
			if(full_name.contains("EE.R&D.Monitor.D_Group") 
					||full_name.contains("CE.R&D.Monitor.D_Group") 
					||full_name.contains("PSU.R&D.Monitor.D_Group") 
					||full_name.contains("ME.R&D.Monitor.D_Group") 
