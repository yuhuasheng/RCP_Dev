...
public class TCFRReportDialog extends Dialog {
	
	private Shell shell = null;	
	
	public TCFRReportDialog(AbstractAIFUIApplication app,Shell parent) throws Exception {
		super(parent);
//		this.shell = parent;
		createContents();
	}
	...
	protected void createContents() throws Exception {
		...
		shell.setText("TCFR Design Review Meeting追蹤報表");
		...
		String url = TCUtil.getPreference(RACUIUtil.getTCSession(), TCPreferenceService.TC_preference_site, "D9_SpringCloud_URL") + "/TCFR";
