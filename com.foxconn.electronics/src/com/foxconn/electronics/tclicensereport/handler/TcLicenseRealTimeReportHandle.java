...
public class TcLicenseRealTimeReportHandle extends AbstractHandler{
	...
	public Object execute(ExecutionEvent arg0) throws ExecutionException {
		try {
			...
			String url = preference + "/LicenseVisualizationBoard";
			System.out.println(url);
			TcLicenseReportDialog licenseReportDialog = new TcLicenseReportDialog(shell, url);
			licenseReportDialog.initUI("LicenseTitle");
		} catch (Exception e) {
			e.printStackTrace();
		}
		return null;
