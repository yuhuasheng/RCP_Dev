...
public class DocPlaceOnFileDialog extends Dialog{
	...
	public DocPlaceOnFileDialog (Shell parentShell, AbstractAIFUIApplication app, String url) {
		super(parentShell);
		this.parentShell = parentShell;
		this.app = app;
		this.url = url;
		this.reg = Registry.getRegistry("com.foxconn.electronics.document.document");
		initUI();
	}
	...
	private void initUI() {
		...
		shell.setText(reg.getString("selectFolderPath"));
