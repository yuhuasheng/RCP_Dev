...
public class AssignWorkersDialog extends Dialog{
	...
	public AssignWorkersDialog (Shell parentShell, Dimension dim, TCSession session, String url,ResourceBundle reg) {
		super(parentShell);
	...
	public void initUI() {
		...
		shell.setText(reg.getString("AssignWorkers.TITLE"));
