package com.foxconn.electronics.login.dialog;
...
public class AccountManagerDialog extends Dialog{
	...
	public AccountManagerDialog (Shell parentShell, TCSession session, String url,ResourceBundle reg) {
		super(parentShell);
	...
	public void initUI() {
		...
		shell.setText(reg.getString("AccountManage.TITLE"));
