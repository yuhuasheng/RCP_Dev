package com.foxconn.electronics.matrixbom.dialog;
...
public class MatrixBOMDialog extends Dialog {
	...
	public Shell shell;
	private MatrixBOMController matrixBOMController;
	
	public MatrixBOMDialog(Shell parent, Dimension dim, String url, MatrixBOMController matrixBOMController) {
		super(parent);
		this.shell = parent;
		this.dim = dim;
		this.url = url;
