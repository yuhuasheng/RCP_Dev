...
public class EBOMLineBean implements Cloneable
{
    ...
    private List<EBOMLineBean> childs;
    ...
    @TCPropName(value = "d9_IsNew")
    private String             isNew;
    @TCPropName(value = "d9_ChineseDescription")
    private String             chineseDescription;
    @TCPropName(value = "bl_substitute_list")
    ...
    public String getSubstituteList()
    {
        return substituteList;
    }

    public void setSubstituteList(String substituteList)
    {
        this.substituteList = substituteList;
    }

    public EBOMLineBean(TCComponentBOMLine bomLine)
    {
        childs = Collections.synchronizedList(new ArrayList<EBOMLineBean>());
        try
        {
            UpdateEBOMService.tcPropMapping(this, bomLine);
