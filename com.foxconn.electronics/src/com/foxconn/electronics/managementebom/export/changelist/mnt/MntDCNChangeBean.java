...
public class MntDCNChangeBean implements Cloneable
{
    ...
    public MntDCNChangeBean(EBOMLineBean ebomBean)
    {
        ...
        this.before_qty = CommonTools.isEmpty(ebomBean.getQty()) ? "1" : ebomBean.getQty();
        this.after_qty = CommonTools.isEmpty(ebomBean.getQty()) ? "1" : ebomBean.getQty();
        this.unit = ebomBean.getUnit();
    }

    public MntDCNChangeBean setDel()
    {
        this.partPn = MntDCNChange.insertDelLabel(this.partPn);
        this.des = MntDCNChange.insertDelLabel(this.des);
        this.location = MntDCNChange.insertDelLabel(this.location);
        this.supplier = MntDCNChange.insertDelLabel(this.supplier);
        this.after_qty = "0";
        return this;
    }
