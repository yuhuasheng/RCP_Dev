...
public class ProgramPhaseLovPropertyBean extends AbstractPropertyBean<Object> {
    ...
    public ProgramPhaseLovPropertyBean() {
        super();
        // TODO Auto-generated constructor stub
        System.out.println("PhaseLov 1");
    }

    public ProgramPhaseLovPropertyBean(Control paramControl) {
        super(paramControl);
        // TODO Auto-generated constructor stub
        System.out.println("PhaseLov 2");
        parent = (Composite) paramControl;
        loadPanel();
    }

    public ProgramPhaseLovPropertyBean(FormToolkit paramFormToolkit,
                                       Composite paramComposite, boolean paramBoolean, Map<?, ?> paramMap) {
        System.out.println("PhaseLov 3");
        this.savable = true;
...
//			String[] values = new String[] { "Folder","infodba (infodba)","#PHASELOV#"};
...
//		}	
    ...
    public Object getEditableValue() {
        ...
        mandatory = false;
        savable = false;
        System.out.println("PhaseLov getEditableValue == "
    ...
    public TCProperty getPropertyToSave(TCProperty arg0) throws Exception {
        // TODO Auto-generated method stub
        System.out.println("PhaseLov getPropertyToSave");
        return arg0;
    }
    ...
    public boolean isPropertyModified(TCProperty arg0) throws Exception {
        // TODO Auto-generated method stub
        System.out.println("PhaseLov isPropertyModified 11111");
        return isModify;
    }
    ...
    public void load(TCProperty arg0) throws Exception {
        // TODO Auto-generated method stub
        System.out.println("PhaseLov load 1");
        // super.load(arg0);
    ...
    public void dispose() {
        ...
        if (prop != null) {
            try {
                ...
                System.out.println("programPhase dispose");
...
//				}	
    ...
    public AIFPropertyDataBean getDataBeanViewModel() {
        // TODO Auto-generated method stub
        // System.out.println("PhaseLov getDataBeanViewModel");
                    ...
                    if (parentContext != null && parentContext.length > 0) {
                        for (int i = 0; i < parentContext.length; i++) {
                            ...
                            if ("Prg0ProgramPlan".equals(component.getType())) {
                                TCComponent programPlan = (TCComponent) component;
                                String customerValue = programPlan.getProperty("prg0Customer");
                                ...
                                if (customerPhaseArr != null && customerPhaseArr.length > 0) {
                                    for (String customerPhaseValue : customerPhaseArr) {
                                        String[] array = customerPhaseValue.split("::");
                                        String customerStr = array[0];

                                        if (customerValue.equals(customerStr)) {
                                            String phaseStr = array[1];
                                            String[] phaseArray = phaseStr.split(",");
                                            for (String phase : phaseArray) {
                                                propLov.addItem(phase);
                                            }
                                            break;
                                        }
                                    }
