...
public class PACRevIdPropertyBean extends AbstractPropertyBean<Object> {
    ...
    public PACRevIdPropertyBean() {
        super();
        // TODO Auto-generated constructor stub
        System.out.println("RevisionId 1");
    }

    public PACRevIdPropertyBean(Control paramControl) {
        super(paramControl);
        // TODO Auto-generated constructor stub
        System.out.println("RevisionId 2");
        parent = (Composite) paramControl;
        loadPanel();
    }

    public PACRevIdPropertyBean(FormToolkit paramFormToolkit,
                                Composite paramComposite, boolean paramBoolean, Map<?, ?> paramMap) {
        System.out.println("RevisionId 3");
        this.savable = true;
    ...
    private void loadPanel() {
        ...
        String[] array = getRevIdList();
        for (String revId : array) {
            propLov.addItem(revId);
        }
    ...
    public Object getEditableValue() {
        ...
        mandatory = false;
        savable = false;
        System.out.println("RevisionId getEditableValue == "
    ...
    public TCProperty getPropertyToSave(TCProperty arg0) throws Exception {
        // TODO Auto-generated method stub
        System.out.println("RevisionId getPropertyToSave");
        return arg0;
    }
    ...
    public boolean isPropertyModified(TCProperty arg0) throws Exception {
        // TODO Auto-generated method stub
        System.out.println("RevisionId isPropertyModified 11111");
        return isModify;
    }
    ...
    public void load(TCProperty arg0) throws Exception {
        // TODO Auto-generated method stub
        System.out.println("RevisionId load 1");
        // super.load(arg0);
    ...
    public AIFPropertyDataBean getDataBeanViewModel() {
        // TODO Auto-generated method stub
        // System.out.println("RevisionId getDataBeanViewModel");
...
//		label41.setForeground(labelComposite.getDisplay().getSystemColor(3));
    ...
    private String[] getRevIdList() {
        return new GetPreferenceUtil().getArrayPreference(session, TCPreferenceService.TC_preference_site, "FX_Get_PACRevId_Values");
    }
