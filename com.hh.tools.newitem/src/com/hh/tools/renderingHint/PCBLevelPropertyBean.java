...
public class PCBLevelPropertyBean extends AbstractPropertyBean<Object> {
    ...
    protected static Text PCPLevelText;

    public PCBLevelPropertyBean(Control paramControl) {
        super(paramControl);
    }

    public PCBLevelPropertyBean(FormToolkit paramFormToolkit, Composite paramComposite, boolean paramBoolean,
                                Map<?, ?> paramMap) {
        this.savable = true;
    ...
    private void initComposite(Composite parentComposite) {
        ...
        PCPLevelText = new Text(this.composite, SWT.BORDER | SWT.LEFT);
        GridData gridData = new GridData(SWT.LEFT, SWT.TOP, false, false, 1, 1);
        gridData.heightHint = 20;
        gridData.widthHint = 320;
        PCPLevelText.setLayoutData(gridData);
    ...
    public static String getText() {
        ...
        String text1 = "";
        if (PCPLevelText != null) {
            text1 = PCPLevelText.getText();
