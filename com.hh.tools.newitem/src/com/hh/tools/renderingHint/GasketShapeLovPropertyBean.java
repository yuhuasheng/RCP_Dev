...
public class GasketShapeLovPropertyBean extends AbstractPropertyBean<Object> {
    ...
    public GasketShapeLovPropertyBean() {
        super();
        // TODO Auto-generated constructor stub
        System.out.println("GasketShape 1");
    }

    public GasketShapeLovPropertyBean(Control paramControl) {
        super(paramControl);
        // TODO Auto-generated constructor stub
        System.out.println("GasketShape 2");
        parent = (Composite) paramControl;
        loadPanel();
    }

    public GasketShapeLovPropertyBean(FormToolkit paramFormToolkit,
                                      Composite paramComposite, boolean paramBoolean, Map<?, ?> paramMap) {
        System.out.println("GasketShape 3");
        this.savable = true;
    ...
    private void loadPanel() {
        ...
        String[] gasketShapeList = getGasketShapeList();
        if (gasketShapeList != null && gasketShapeList.length > 0) {
            for (String gasketShape : gasketShapeList) {
                propLov.addItem(gasketShape);
            }
        }
        setControl(composite);
    }

    private String[] getGasketShapeList() {
        return new GetPreferenceUtil().getArrayPreference(session, TCPreferenceService.TC_preference_site, "FX_Get_Gasket_Shape_Values");
    }
    ...
    public Object getEditableValue() {
        ...
        mandatory = false;
        savable = false;
        System.out.println("GasketShape getEditableValue == "
    ...
    public TCProperty getPropertyToSave(TCProperty arg0) throws Exception {
        // TODO Auto-generated method stub
        System.out.println("GasketShape getPropertyToSave");
        return arg0;
    }
    ...
    public boolean isPropertyModified(TCProperty arg0) throws Exception {
        // TODO Auto-generated method stub
        System.out.println("GasketShape isPropertyModified 11111");
        return isModify;
    }
    ...
    public void load(TCProperty arg0) throws Exception {
        // TODO Auto-generated method stub
        System.out.println("GasketShape load 1");
        // super.load(arg0);
    ...
    public void dispose() {
        ...
        if (prop != null) {
            try {
                ...
                if (!groupFullName.contains("Monitor.D_Group") && !groupFullName.contains("Printer.D_Group") && ItemTypeName.GASKETREVISION.equals(com.getType())) {
    ...
    public AIFPropertyDataBean getDataBeanViewModel() {
        // TODO Auto-generated method stub
        // System.out.println("GasketShape getDataBeanViewModel");
