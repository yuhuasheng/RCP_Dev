...
public class RubberObjectNamePropertyBean extends AbstractPropertyBean<Object> {
    ...
    public RubberObjectNamePropertyBean(Control paramControl) {
        super(paramControl);
    }

    public RubberObjectNamePropertyBean(FormToolkit paramFormToolkit, Composite paramComposite, boolean paramBoolean,
                                        Map<?, ?> paramMap) {
        this.savable = true;
