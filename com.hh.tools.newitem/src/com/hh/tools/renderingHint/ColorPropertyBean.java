...
public class ColorPropertyBean extends AbstractPropertyBean<Object> {
    ...
    protected static Text colorText;

    public ColorPropertyBean(Control paramControl) {
        super(paramControl);
    }

    public ColorPropertyBean(FormToolkit paramFormToolkit, Composite paramComposite, boolean paramBoolean,
                             Map<?, ?> paramMap) {
        this.savable = true;
    ...
    private void doSave() {
        try {
            ...
            if (!groupFullName.contains("Monitor.D_Group") && !groupFullName.contains("Printer.D_Group") && ItemTypeName.SCREWREVISION.equals(com.getType())) {
            ...
            } else if (!groupFullName.contains("Monitor.D_Group") && !groupFullName.contains("Printer.D_Group") && ItemTypeName.STANDOFFREVISION.equals(com.getType())) {
    ...
    public void load(TCPropertyDescriptor paramTCPropertyDescriptor) throws Exception {
        ...
        if (!Utils.isNull(defaultValue)) colorText.setText(defaultValue);
    }
