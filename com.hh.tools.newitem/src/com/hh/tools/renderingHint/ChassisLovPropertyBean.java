...
public class ChassisLovPropertyBean extends AbstractPropertyBean<Object> {
    ...
    public ChassisLovPropertyBean() {
        super();
        // TODO Auto-generated constructor stub
        System.out.println("Chassis 1");
    }

    public ChassisLovPropertyBean(Control paramControl) {
        super(paramControl);
        // TODO Auto-generated constructor stub
        System.out.println("Chassis 2");
        parent = (Composite) paramControl;
        loadPanel();
    }

    public ChassisLovPropertyBean(FormToolkit paramFormToolkit,
                                  Composite paramComposite, boolean paramBoolean, Map<?, ?> paramMap) {
        System.out.println("Chassis 3");
        this.savable = true;
    ...
    private void loadPanel() {
        ...
        String[] chassisList = getChasisList();
        if (chassisList != null && chassisList.length > 0) {
            for (String chassis : chassisList) {
                propLov.addItem(chassis);
            }
        }
        setControl(composite);
    }

    private String[] getChasisList() {
        return new GetPreferenceUtil().getArrayPreference(session, TCPreferenceService.TC_preference_site, "FX_Get_Mechanism_Location_Values");
    }
    ...
    public Object getEditableValue() {
        ...
        mandatory = false;
        savable = false;
        System.out.println("Chassis getEditableValue == "
    ...
    public TCProperty getPropertyToSave(TCProperty arg0) throws Exception {
        // TODO Auto-generated method stub
        System.out.println("Chassis getPropertyToSave");
        return arg0;
    }
    ...
    public boolean isPropertyModified(TCProperty arg0) throws Exception {
        // TODO Auto-generated method stub
        System.out.println("Chassis isPropertyModified 11111");
        return isModify;
    }
    ...
    public void load(TCProperty arg0) throws Exception {
        // TODO Auto-generated method stub
        System.out.println("Chassis load 1");
        // super.load(arg0);
    ...
    public AIFPropertyDataBean getDataBeanViewModel() {
        // TODO Auto-generated method stub
        // System.out.println("Chassis getDataBeanViewModel");
