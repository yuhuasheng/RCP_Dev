...
public class HeadShapePropertyBean extends AbstractPropertyBean<Object> {
    ...
    protected static Text headShapeText;


    public HeadShapePropertyBean(Control paramControl) {
        super(paramControl);
    }

    public HeadShapePropertyBean(FormToolkit paramFormToolkit, Composite paramComposite, boolean paramBoolean,
                                 Map<?, ?> paramMap) {
        this.savable = true;
    ...
    private void initComposite(Composite parentComposite) {
        ...
        headShapeText = new Text(this.composite, SWT.BORDER | SWT.LEFT);
        GridData gridData = new GridData(SWT.LEFT, SWT.TOP, false, false, 1, 1);
        gridData.heightHint = 20;
        gridData.widthHint = 320;
        headShapeText.setLayoutData(gridData);
        headShapeText.addModifyListener(new ModifyListener() {
            @Override
    ...
    public static String getText() {
        ...
        String text1 = "";
        if (headShapeText != null) {
            text1 = headShapeText.getText();
    ...
    public void load(TCPropertyDescriptor paramTCPropertyDescriptor) throws Exception {
        ...
        if (!Utils.isNull(defaultValue)) headShapeText.setText(defaultValue);
    }
