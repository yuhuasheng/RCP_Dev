...
public class ProfitCenterLovPropertyBean extends AbstractPropertyBean<Object> {
    ...
    public ProfitCenterLovPropertyBean() {
        super();
        // TODO Auto-generated constructor stub
        System.out.println("ProfitCenter 1");
    }

    public ProfitCenterLovPropertyBean(Control paramControl) {
        super(paramControl);
        // TODO Auto-generated constructor stub
        System.out.println("ProfitCenter 2");
        parent = (Composite) paramControl;
        loadPanel();
    }

    public ProfitCenterLovPropertyBean(FormToolkit paramFormToolkit,
                                       Composite paramComposite, boolean paramBoolean, Map<?, ?> paramMap) {
        System.out.println("ProfitCenter 3");
        this.savable = true;
    ...
    public static String getText() {
        ...
        System.out.println("ProfitCenter text1 == " + text1);
        return text1;
    }
    ...
    public static void Clear() {
        if (propLov != null) {
            ...
            propLov.update();
            System.out.println("Çå¿ÕProfitCenter");
        }
    ...
    public static void loadPop() {
        if (propLov != null && !propLov.isDisposed()) {
            ...
            String[] ProfitCenterArr = new GetPreferenceUtil().getArrayPreference(session, TCPreferenceService.TC_preference_site, "FX_Get_ProfitCenter_Values");
            if (ProfitCenterArr != null && ProfitCenterArr.length > 0) {
                List<MRPDemo> mrpDemoList = new ArrayList<>();
                for (String ProfitCenterValue : ProfitCenterArr) {
                    String[] ProfitCenter = ProfitCenterValue.split("::");
                    String plantStr = ProfitCenter[0];
                    String factoryStr = ProfitCenter[1];
                    String ProfitCenterStr = ProfitCenter[2];
                    String[] ProfitCenterArrStr = ProfitCenterStr.split(",");
                    MRPDemo mrpDemo = new MRPDemo(plantStr, factoryStr, ProfitCenterArrStr);
                ...
                for (MRPDemo mrpDemo : mrpDemoList) {
                    if (mrpDemo.getPlant().equals(plant) && mrpDemo.getFactory().equals(factory)) {
                        ProfitCenterArray = mrpDemo.getMrpArray();
                        break;
                    }
                }
                if (ProfitCenterArray != null && ProfitCenterArray.length > 0) {
                    for (String ProfitCenter : ProfitCenterArray) {
                        propLov.addItem(ProfitCenter);
                    }
                } else {
                    propLov.setText("");
                }
    ...
    public Object getEditableValue() {
        ...
        mandatory = false;
        savable = true;
        System.out.println("ProfitCenterLov getEditableValue == " + textField.getText());
        Object ob = textField.getText();
        System.out.println("ProfitCenter ob == " + ob);
        return ob;
    }
    ...
    public TCProperty getPropertyToSave(TCProperty arg0) throws Exception {
        // TODO Auto-generated method stub
        System.out.println("ProfitCenter getPropertyToSave");
        return arg0;
    }
    ...
    public boolean isPropertyModified(TCProperty arg0) throws Exception {
        // TODO Auto-generated method stub
        System.out.println("ProfitCenter isPropertyModified 11111");
        return isModify;
    }
    ...
    public AIFPropertyDataBean getDataBeanViewModel() {
        // TODO Auto-generated method stub
        // System.out.println("ProfitCenter getDataBeanViewModel");
...
//	private void doSave() {
//		String costCenter = getText();
//		try {
//			if(!Utils.isNull(costCenter)){
//				component.setProperty("fx8_CostCenter", costCenter);	
//			}else{
//				component.setProperty("fx8_CostCenter", null);	
//			}
//		} catch (Exception e) {
//			e.printStackTrace();
//		}		
...
//		super.setLabelComposite(arg0);		
        System.out.println("ProfitCenter setLabelComposite 12");
        super.setLabelComposite(arg0);
    }
