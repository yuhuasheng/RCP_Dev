...
public class LXDiagObjectNamePropertyBean extends AbstractPropertyBean<Object> {
    ...
    public static Text objectNameText;

    public LXDiagObjectNamePropertyBean(Control paramControl) {
        super(paramControl);
    }

    public LXDiagObjectNamePropertyBean(FormToolkit paramFormToolkit, Composite paramComposite, boolean paramBoolean,
                                        Map<?, ?> paramMap) {
        this.savable = true;
