...
public class MfgPNPropertyBean extends AbstractPropertyBean<Object> {
    ...
    protected static Text MfgPNText;

    public MfgPNPropertyBean(Control paramControl) {
        super(paramControl);
    }

    public MfgPNPropertyBean(FormToolkit paramFormToolkit, Composite paramComposite, boolean paramBoolean,
                             Map<?, ?> paramMap) {
        this.savable = true;
    ...
    private void initComposite(Composite parentComposite) {
        ...
        MfgPNText = new Text(this.composite, SWT.BORDER | SWT.LEFT);
        GridData gridData = new GridData(SWT.LEFT, SWT.TOP, false, false, 1, 1);
        gridData.heightHint = 20;
        gridData.widthHint = 320;
        MfgPNText.setLayoutData(gridData);
    ...
    public void load(TCPropertyDescriptor paramTCPropertyDescriptor) throws Exception {
        ...
        if (defaultValue != null && defaultValue.length() > 0) MfgPNText.setText(defaultValue);
    }
    ...
    public void dispose() {
        ...
        if (tcProperty != null) {
            try {
                com.setProperty(property, MfgPNText.getText());
            } catch (TCException e) {
