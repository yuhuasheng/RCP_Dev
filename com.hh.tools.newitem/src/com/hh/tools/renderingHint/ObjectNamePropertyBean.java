...
public class ObjectNamePropertyBean extends AbstractPropertyBean<Object> {
    ...
    protected static Text objectNameText;

    public ObjectNamePropertyBean(Control paramControl) {
        super(paramControl);
    }

    public ObjectNamePropertyBean(FormToolkit paramFormToolkit, Composite paramComposite, boolean paramBoolean,
                                  Map<?, ?> paramMap) {
        this.savable = true;
