...
public class FactoryLovPropertyBean extends AbstractPropertyBean<Object> {
    ...
    public FactoryLovPropertyBean() {
        super();
        // TODO Auto-generated constructor stub
        System.out.println("Factory 1");
    }

    public FactoryLovPropertyBean(Control paramControl) {
        super(paramControl);
        // TODO Auto-generated constructor stub
    ...
    public FactoryLovPropertyBean(FormToolkit paramFormToolkit,
    ...
    private void loadPanel() {
        ...
        textField.addModifyListener(new ModifyListener() {
            ...
            public void modifyText(ModifyEvent paramModifyEvent) {
                // TODO Auto-generated method stub
                System.out.println("FactoryLov modifyText");
...
//					setDirty(true);
                    ...
                    if ("".equals(textField.getText())) {
                        // 清空MRPGroup
                        MRPGroupLovPropertyBean.Clear();
                        // 清空StorageLocation
                        StorageLocationLovPropertyBean.Clear();
                        // 清空ProfitCenter
                        ProfitCenterLovPropertyBean.Clear();
                    } else {
                        // 加载MRPGroup
                        MRPGroupLovPropertyBean.loadPop();
                        // 加载StorageLocation
                        StorageLocationLovPropertyBean.loadPop();
                        // 加载ProfitCenter
                        ProfitCenterLovPropertyBean.loadPop();
                    }
                }
    ...
    public static String getText() {
        ...
        System.out.println("Factory text1 == " + text1);
        return text1;
    }

    public static void setText(String factoryStr) {
        if (propLov != null) {
            propLov.setSelectedItem(factoryStr);
        }
    }
    ...
    public Object getEditableValue() {
        ...
        mandatory = false;
        savable = true;
        System.out.println("FactoryLov getEditableValue == " + textField.getText());
        Object ob = textField.getText();
        System.out.println("Factory ob ==" + ob);
        return ob;
    }
    ...
    public TCProperty getPropertyToSave(TCProperty arg0) throws Exception {
        // TODO Auto-generated method stub
        System.out.println("Factory getPropertyToSave");
        return arg0;
    }
    ...
    public boolean isPropertyModified(TCProperty arg0) throws Exception {
        // TODO Auto-generated method stub
        System.out.println("Factory isPropertyModified 11111");
        return isModify;
    }
    ...
    public void load(TCPropertyDescriptor paramTCPropertyDescriptor) throws Exception {
        ...
        ArrayList<String> values = Utils.getLOVList(paramTCPropertyDescriptor.getLOV());
        if (values.size() > 0) {
            for (String value : values) {
                propLov.addItem(value);
            }
    ...
    public AIFPropertyDataBean getDataBeanViewModel() {
        // TODO Auto-generated method stub
        // System.out.println("Factory getDataBeanViewModel");
...
//	private void doSave() {
//		String factory = getText();
//		try {
//			if(!Utils.isNull(factory)){
//				component.setProperty("fx8_Factory", factory);	
//			}else{
//				component.setProperty("fx8_Factory", null);	
//			}	
//		} catch (Exception e) {
//			e.printStackTrace();
//		}		
...
//		super.setLabelComposite(arg0);		
        System.out.println("Factory setLabelComposite 12");
        super.setLabelComposite(arg0);
    }
