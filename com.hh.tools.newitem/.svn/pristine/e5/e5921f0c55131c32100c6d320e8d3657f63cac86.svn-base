...
public class PurposeLovPropertyBean extends AbstractPropertyBean<Object> {
    ...
    public PurposeLovPropertyBean() {
        super();
        // TODO Auto-generated constructor stub
        System.out.println("PurposeLov 1");
    }

    public PurposeLovPropertyBean(Control paramControl) {
        super(paramControl);
        // TODO Auto-generated constructor stub
        System.out.println("PurposeLov 2");
        parent = (Composite) paramControl;
        loadPanel();
    }

    public PurposeLovPropertyBean(FormToolkit paramFormToolkit,
                                  Composite paramComposite, boolean paramBoolean, Map<?, ?> paramMap) {
        System.out.println("PurposeLov 3");
        this.savable = true;
    ...
    private void loadPanel() {
        ...
        String[] purposeList = getPurposeList();
        if (purposeList != null && purposeList.length > 0) {
            for (String purpose : purposeList) {
                propLov.addItem(purpose);
            }
        }
        setControl(composite);
    }

    private String[] getPurposeList() {
        return new GetPreferenceUtil().getArrayPreference(session, TCPreferenceService.TC_preference_site, "FOX_Sheetmetal_Purpose");
    }
    ...
    public Object getEditableValue() {
        ...
        mandatory = false;
        savable = false;
        System.out.println("PurposeLov getEditableValue == "
    ...
    public TCProperty getPropertyToSave(TCProperty arg0) throws Exception {
        // TODO Auto-generated method stub
        System.out.println("PurposeLov getPropertyToSave");
        return arg0;
    }
    ...
    public boolean isPropertyModified(TCProperty arg0) throws Exception {
        // TODO Auto-generated method stub
        System.out.println("PurposeLov isPropertyModified 11111");
        return isModify;
    }
    ...
    public void load(TCProperty arg0) throws Exception {
        // TODO Auto-generated method stub
        System.out.println("PurposeLov load 1");
        // super.load(arg0);
    ...
    public AIFPropertyDataBean getDataBeanViewModel() {
        // TODO Auto-generated method stub
        // System.out.println("PurposeLov getDataBeanViewModel");
