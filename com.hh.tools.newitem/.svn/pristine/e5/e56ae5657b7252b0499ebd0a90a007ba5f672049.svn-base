...
public class RubberShapeLovPropertyBean extends AbstractPropertyBean<Object> {
    ...
    public RubberShapeLovPropertyBean() {
        super();
        // TODO Auto-generated constructor stub
        System.out.println("RubberShape 1");
    }

    public RubberShapeLovPropertyBean(Control paramControl) {
        super(paramControl);
        // TODO Auto-generated constructor stub
        System.out.println("RubberShape 2");
        parent = (Composite) paramControl;
        loadPanel();
    }

    public RubberShapeLovPropertyBean(FormToolkit paramFormToolkit,
                                      Composite paramComposite, boolean paramBoolean, Map<?, ?> paramMap) {
        System.out.println("RubberShape 3");
        this.savable = true;
    ...
    private void loadPanel() {
        ...
        String[] rubberShapeList = getRubberShapeList();
        if (rubberShapeList != null && rubberShapeList.length > 0) {
            for (String rubberShape : rubberShapeList) {
                propLov.addItem(rubberShape);
            }
        }
        setControl(composite);
    }

    private String[] getRubberShapeList() {
        return new GetPreferenceUtil().getArrayPreference(session, TCPreferenceService.TC_preference_site, "FX_Get_Rubber_Shape_Values");
    }
    ...
    public Object getEditableValue() {
        ...
        mandatory = false;
        savable = false;
        System.out.println("RubberShape getEditableValue == "
    ...
    public TCProperty getPropertyToSave(TCProperty arg0) throws Exception {
        // TODO Auto-generated method stub
        System.out.println("RubberShape getPropertyToSave");
        return arg0;
    }
    ...
    public boolean isPropertyModified(TCProperty arg0) throws Exception {
        // TODO Auto-generated method stub
        System.out.println("RubberShape isPropertyModified 11111");
        return isModify;
    }
    ...
    public void load(TCProperty arg0) throws Exception {
        // TODO Auto-generated method stub
        System.out.println("RubberShape load 1");
        // super.load(arg0);
    ...
    public void dispose() {
        ...
        if (prop != null) {
            try {
                ...
                if (!groupFullName.contains("Monitor.D_Group") && !groupFullName.contains("Printer.D_Group") && ItemTypeName.RUBBERREVISION.equals(com.getType())) {
    ...
    public AIFPropertyDataBean getDataBeanViewModel() {
        // TODO Auto-generated method stub
        // System.out.println("RubberShape getDataBeanViewModel");
