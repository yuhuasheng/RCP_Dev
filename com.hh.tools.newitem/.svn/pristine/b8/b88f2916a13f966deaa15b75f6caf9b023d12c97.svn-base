...
public class SReportTypeLovPropertyBean extends AbstractPropertyBean<Object> {
    ...
    public SReportTypeLovPropertyBean() {
        super();
        // TODO Auto-generated constructor stub
        System.out.println("MainPlantsLov1 1");
    }

    public SReportTypeLovPropertyBean(Control paramControl) {
        super(paramControl);
        // TODO Auto-generated constructor stub
    ...
    public SReportTypeLovPropertyBean(FormToolkit paramFormToolkit,
    ...
    private void loadPanel() {
        ...
        try {
            ...
            String[] values = new String[]{"Folder", "infodba (infodba)", "#SYSSIMRPTTYPE#"};
