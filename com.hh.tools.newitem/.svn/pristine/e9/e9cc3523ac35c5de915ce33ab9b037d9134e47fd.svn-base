...
public class TestPropertyBean extends AbstractPropertyBean<Object> {
    ...
    protected static Text testText;
    private SimpleDateFormat simpleFormat = new SimpleDateFormat("yyyy-M-dd");

    public TestPropertyBean(Control paramControl) {
        super(paramControl);
    }

    public TestPropertyBean(FormToolkit paramFormToolkit, Composite paramComposite, boolean paramBoolean,
                            Map<?, ?> paramMap) {
        this.savable = true;
    ...
    private void initComposite(Composite parentComposite) {
        ...
        testText = new Text(this.composite, SWT.BORDER | SWT.LEFT);
        ...
        testText.addModifyListener(modifyListener);
