...
public class SpecificationPropertyBean extends AbstractPropertyBean<Object> {
    ...
    protected static Text SpecificationText;

    public SpecificationPropertyBean(Control paramControl) {
        super(paramControl);
    }

    public SpecificationPropertyBean(FormToolkit paramFormToolkit, Composite paramComposite, boolean paramBoolean,
                                     Map<?, ?> paramMap) {
        this.savable = true;
    ...
    private void initComposite(Composite parentComposite) {
        ...
        SpecificationText = new Text(this.composite, SWT.BORDER | SWT.LEFT);
    ...
    public static String getText() {
        ...
        if (SpecificationText != null) {
            text1 = SpecificationText.getText();
    ...
    public void load(TCProperty paramTCProperty) throws Exception {
        ...
        SpecificationText.setText(value);
    }
    ...
    public void load(TCPropertyDescriptor paramTCPropertyDescriptor) throws Exception {
        ...
        if (!Utils.isNull(defaultValue)) SpecificationText.setText(defaultValue);
    }
