...
public class CustomerPhaseLovPropertyBean extends AbstractPropertyBean<Object> {
    ...
    public CustomerPhaseLovPropertyBean() {
        super();
        // TODO Auto-generated constructor stub
        System.out.println("MRPGroup 1");
    }

    public CustomerPhaseLovPropertyBean(Control paramControl) {
        super(paramControl);
        // TODO Auto-generated constructor stub
    ...
    public CustomerPhaseLovPropertyBean(FormToolkit paramFormToolkit,
    ...
    public static void loadPop() {
        if (propLov != null && !propLov.isDisposed()) {
            ...
            propLov.setSelectedItem("");
            propLov.update();
            String customerValue = CustomerLovPropertyBean.getText();
...
//		setDirty(false);
        ...
        mandatory = false;
        savable = false;
        System.out.println("MRPGroup getEditableValue == "
    ...
    private void doSave() {
        try {
            String phase = getText();
            if (!Utils.isNull(phase)) {
                component.setProperty("fx8_Phase", phase);
            } else {
                component.setProperty("fx8_Phase", null);
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
