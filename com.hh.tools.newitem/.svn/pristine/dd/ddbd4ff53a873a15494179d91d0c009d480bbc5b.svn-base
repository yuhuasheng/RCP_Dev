...
public class MylarObjectNamePropertyBean extends AbstractPropertyBean<Object> {
    ...
    public MylarObjectNamePropertyBean(Control paramControl) {
        super(paramControl);
    }

    public MylarObjectNamePropertyBean(FormToolkit paramFormToolkit, Composite paramComposite, boolean paramBoolean,
                                       Map<?, ?> paramMap) {
        this.savable = true;
