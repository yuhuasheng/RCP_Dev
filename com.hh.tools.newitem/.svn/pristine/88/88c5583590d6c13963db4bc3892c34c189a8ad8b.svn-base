...
public class StorageLocationLovPropertyBean extends AbstractPropertyBean<Object> {
    ...
    public StorageLocationLovPropertyBean() {
        super();
        // TODO Auto-generated constructor stub
        System.out.println("StorageLocation 1");
    }

    public StorageLocationLovPropertyBean(Control paramControl) {
        super(paramControl);
        // TODO Auto-generated constructor stub
        System.out.println("StorageLocation 2");
        parent = (Composite) paramControl;
        loadPanel();
    }

    public StorageLocationLovPropertyBean(FormToolkit paramFormToolkit,
                                          Composite paramComposite, boolean paramBoolean, Map<?, ?> paramMap) {
        System.out.println("StorageLocation 3");
        this.savable = true;
    ...
    public static String getText() {
        ...
        String text1 = "";
        if (propLov != null && propLov.getTextField() != null) {
            text1 = propLov.getTextField().getText();
        }
        System.out.println("storageLocation text1 == " + text1);
        return text1;
    }
    ...
    public static void Clear() {
        if (propLov != null) {
            ...
            propLov.update();
            System.out.println("Çå¿ÕStorageLocation");
        }
    ...
    public static void loadPop() {
        if (propLov != null && !propLov.isDisposed()) {
            ...
            String[] storageLocationArr = new GetPreferenceUtil().getArrayPreference(session, TCPreferenceService.TC_preference_site, "FX_Get_StorageLocation_Values");

            if (storageLocationArr != null && storageLocationArr.length > 0) {
                List<MRPDemo> mrpDemoList = new ArrayList<>();
                for (String storageLocationValue : storageLocationArr) {
                    String[] storageLocation = storageLocationValue.split("::");
                    String plantStr = storageLocation[0];
                    String factoryStr = storageLocation[1];
                    String storageLocationStr = storageLocation[2];
                    String[] storageLocationArrStr = storageLocationStr.split(",");
                    MRPDemo mrpDemo = new MRPDemo(plantStr, factoryStr, storageLocationArrStr);
                    mrpDemoList.add(mrpDemo);
                }
                String[] storageLocationArray = null;
                for (MRPDemo mrpDemo : mrpDemoList) {
                    if (mrpDemo.getPlant().equals(plant) && mrpDemo.getFactory().equals(factory)) {
                        storageLocationArray = mrpDemo.getMrpArray();
                        break;
                    }
                }
                if (storageLocationArray != null && storageLocationArray.length > 0) {
                    for (String storageLocation : storageLocationArray) {
                        propLov.addItem(storageLocation);
                    }
                } else {
                    propLov.setText("");
                }
    ...
    public Object getEditableValue() {
        ...
        mandatory = false;
        savable = true;
        System.out.println("storageLocationLov getEditableValue == " + textField.getText());
        Object ob = textField.getText();
        System.out.println("storageLocation ob ==" + ob);
        return ob;
    }
    ...
    public TCProperty getPropertyToSave(TCProperty arg0) throws Exception {
        // TODO Auto-generated method stub
        System.out.println("StorageLocation getPropertyToSave");
        return arg0;
    }
    ...
    public boolean isPropertyModified(TCProperty arg0) throws Exception {
        // TODO Auto-generated method stub
        System.out.println("StorageLocation isPropertyModified 11111");
        return isModify;
    }
    ...
    public AIFPropertyDataBean getDataBeanViewModel() {
        // TODO Auto-generated method stub
        // System.out.println("StorageLocation getDataBeanViewModel");
...
//	private void doSave() {
//		String warehouseCode = getText();
//		try {
//			if(!Utils.isNull(warehouseCode)){		
//				component.setProperty("fx8_WarehouseCode", warehouseCode);	
//			}else{
//				component.setProperty("fx8_WarehouseCode", null);	
//			}
//		} catch (Exception e) {
//			e.printStackTrace();
//		}	
...
//		super.setLabelComposite(arg0);		
        System.out.println("StorageLocation setLabelComposite 12");
        super.setLabelComposite(arg0);
    }
