...
public class OptionalPropertyBean extends AbstractPropertyBean<Object> {
    ...
    protected static Text optionalText;
    private SimpleDateFormat simpleFormat = new SimpleDateFormat("yyyy-M-dd");

    public OptionalPropertyBean(Control paramControl) {
        super(paramControl);
    }

    public OptionalPropertyBean(FormToolkit paramFormToolkit, Composite paramComposite, boolean paramBoolean,
                                Map<?, ?> paramMap) {
        this.savable = true;
    ...
    private void initComposite(Composite parentComposite) {
        ...
        optionalText = new Text(this.composite, SWT.BORDER | SWT.LEFT);
        GridData gridData = new GridData(SWT.LEFT, SWT.TOP, false, false, 1, 1);
        gridData.heightHint = 20;
        gridData.widthHint = 320;
        optionalText.setLayoutData(gridData);
        ...
        optionalText.addModifyListener(modifyListener);
    ...
    public void load(TCPropertyDescriptor paramTCPropertyDescriptor) throws Exception {
        ...
        optionalText.setText(defaultValue);
    }
