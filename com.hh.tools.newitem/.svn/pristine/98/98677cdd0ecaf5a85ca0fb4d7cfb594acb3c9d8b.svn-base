...
public class ScrewObjectNamePropertyBean extends AbstractPropertyBean<Object> {
    ...
    public ScrewObjectNamePropertyBean(Control paramControl) {
        super(paramControl);
    }

    public ScrewObjectNamePropertyBean(FormToolkit paramFormToolkit, Composite paramComposite, boolean paramBoolean,
                                       Map<?, ?> paramMap) {
        this.savable = true;
