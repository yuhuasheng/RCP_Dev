...
public class PlantformLovPropertyBean extends AbstractPropertyBean<Object> {
    ...
    public PlantformLovPropertyBean() {
        super();
        // TODO Auto-generated constructor stub
        System.out.println("Plantform 1");
    }

    public PlantformLovPropertyBean(Control paramControl) {
        super(paramControl);
        // TODO Auto-generated constructor stub
        System.out.println("Plantform 2");
        parent = (Composite) paramControl;
        loadPanel();
    }

    public PlantformLovPropertyBean(FormToolkit paramFormToolkit,
                                    Composite paramComposite, boolean paramBoolean, Map<?, ?> paramMap) {
        System.out.println("Plantform 3");
        this.savable = true;
    ...
    public Object getEditableValue() {
        ...
        mandatory = false;
        savable = false;
        System.out.println("Plantform getEditableValue == "
    ...
    public TCProperty getPropertyToSave(TCProperty arg0) throws Exception {
        // TODO Auto-generated method stub
        System.out.println("Plantform getPropertyToSave");
        return arg0;
    }
    ...
    public boolean isPropertyModified(TCProperty arg0) throws Exception {
        // TODO Auto-generated method stub
        System.out.println("Plantform isPropertyModified 11111");
        return isModify;
    }
    ...
    public void load(TCProperty paramTCProperty) throws Exception {
        // TODO Auto-generated method stub
        System.out.println("Plantform load 1");
        // super.load(arg0);
        com = paramTCProperty.getTCComponent().getTypeComponent();
        property = paramTCProperty.getPropertyName();
        descriptor = paramTCProperty.getPropertyDescriptor();
        prop = paramTCProperty;
        component = paramTCProperty.getTCComponent();
        typename = descriptor.getTypeComponent().getTypeName();
        ArrayList<String> values = Utils.getLOVList(descriptor.getLOV());
        if (values.size() > 0) {
            for (String value : values) {
                propLov.addItem(value);
            }
        }
        String selectedValue = paramTCProperty.getStringValue();
    ...
    public AIFPropertyDataBean getDataBeanViewModel() {
        // TODO Auto-generated method stub
        // System.out.println("Plantform getDataBeanViewModel");
...
//	private void doSave() {
//		try {
//			String plantformStr = getText();
//			if(!Utils.isNull(plantformStr)){
//				component.setProperty("fx8_Platform", plantformStr);
//			}else{
//				component.setProperty("fx8_Platform", null);
//			}			
//			if(ItemTypeName.ESIMULATIONREVISION.equals(component.getType())){
//				StringBuffer buffer = new StringBuffer();
//				String projectStr = ProjectLovPropertyBean.getText();
//				if(!Utils.isNull(projectStr)){
//					buffer.append(projectStr);
//				}else{
//					return;
//				}
//				if(!Utils.isNull(plantformStr)){
//					buffer.append("_"+plantformStr);
//				}else{
//					return;
//				}
//				String PCBLevelStr = PCBLevelLovPropertyBean.getText();
//				if(!Utils.isNull(PCBLevelStr)){
//					buffer.append("_"+PCBLevelStr);
//				}else{
//					return;
//				}
//				String productTypeStr = ProductTypeLovPropertyBean.getText();
//				if(!Utils.isNull(productTypeStr)){
//					buffer.append("_"+productTypeStr);
//				}else{
//					return;
//				}
//				String optionalStr = OptionalPropertyBean.getText();
//				if(!Utils.isNull(optionalStr)){
//					buffer.append("_"+optionalStr);
//				}
//				String EReportTypeStr = EReportTypeLovPropertyBean.getText();
//				if(!Utils.isNull(EReportTypeStr)){
//					buffer.append("_"+EReportTypeStr);
//				}else{
//					return;
//				}	
//				String revvId = component.getProperty("item_revision_id");
//				if(!Utils.isNull(revvId)){
//					buffer.append("_"+revvId);
//				}else{
//					return;
//				}	
//				Date finishDate = component.getDateProperty("fx8_Date");
//				String finishDateStr = simpleFormat.format(finishDate);
//				if(!Utils.isNull(finishDateStr)){
//					buffer.append("_"+finishDateStr);
//				}else{
//					return;
//				}
