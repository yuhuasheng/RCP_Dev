...
public class ProductTypeLovPropertyBean extends AbstractPropertyBean<Object> {
    ...
    public ProductTypeLovPropertyBean() {
        super();
        // TODO Auto-generated constructor stub
        System.out.println("MainPlantsLov1 1");
    }

    public ProductTypeLovPropertyBean(Control paramControl) {
        super(paramControl);
        // TODO Auto-generated constructor stub
    ...
    public ProductTypeLovPropertyBean(FormToolkit paramFormToolkit,
    ...
    private void loadPanel() {
        ...
        try {
            ...
            String[] values = new String[]{"Folder", "infodba (infodba)", "#PRODLINE#"};
