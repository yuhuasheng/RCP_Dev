...
public class ApprovalStatusPropertyBean extends AbstractPropertyBean<Object> {
    ...
    public ApprovalStatusPropertyBean() {
        super();
        // TODO Auto-generated constructor stub
        System.out.println("ApprovalStatus 1");
    }

    public ApprovalStatusPropertyBean(Control paramControl) {
        super(paramControl);
    }

    public ApprovalStatusPropertyBean(FormToolkit paramFormToolkit,
                                      Composite paramComposite, boolean paramBoolean, Map<?, ?> paramMap) {
        System.out.println("ApprovalStatus 3");
        this.savable = true;
    ...
    private void loadPanel(Composite parentComposite) {
        ...
        propLov.setEnabled(false);
        textField = propLov.getTextField();

        editButton = new Button(this.composite, SWT.NONE);
        editButton.setText("Edit");
        editButton.computeSize(80, 25);
    ...
    private void addListeners() {
        Listener addlistener = new Listener() {
            ...
            public void handleEvent(Event event) {
                String compApproval = CompApprovalPropertyBean.getText();
                if ("D".equals(compApproval)) {
                    propLov.setEnabled(false);
                } else {
                    propLov.setEnabled(true);
                }

            }

        };
        editButton.addListener(SWT.Selection, addlistener);
    }
    ...
    public Object getEditableValue() {
        ...
        mandatory = false;
        savable = false;
        System.out.println("ApprovalStatus getEditableValue == "
    ...
    public TCProperty getPropertyToSave(TCProperty arg0) throws Exception {
        // TODO Auto-generated method stub
        System.out.println("ApprovalStatus getPropertyToSave");
        return arg0;
    }
    ...
    public boolean isPropertyModified(TCProperty arg0) throws Exception {
        // TODO Auto-generated method stub
        System.out.println("ApprovalStatus isPropertyModified 11111");
        return isModify;
    }
    ...
    public void load(TCProperty arg0) throws Exception {
        // TODO Auto-generated method stub
        System.out.println("ApprovalStatus load 1");
        // super.load(arg0);
    ...
    public AIFPropertyDataBean getDataBeanViewModel() {
        // TODO Auto-generated method stub
        // System.out.println("ApprovalStatus getDataBeanViewModel");
