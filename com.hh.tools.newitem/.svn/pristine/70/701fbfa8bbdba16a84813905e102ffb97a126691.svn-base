...
public class PlantLovPropertyBean extends AbstractPropertyBean<Object> {
    ...
    public PlantLovPropertyBean() {
        super();
        // TODO Auto-generated constructor stub
        System.out.println("Plant 1");
    }

    public PlantLovPropertyBean(Control paramControl) {
        super(paramControl);
        // TODO Auto-generated constructor stub
    ...
    public PlantLovPropertyBean(FormToolkit paramFormToolkit,
...
//					setDirty(true);
    ...
    public static String getText() {
        ...
        System.out.println("plant text1 == " + text1);
        return text1;
    }
    ...
    public Object getEditableValue() {
        ...
        mandatory = false;
        savable = true;
        System.out.println("plantLov getEditableValue == " + textField.getText());
        Object ob = textField.getText();
        System.out.println("plant ob ==" + ob);
        return ob;
    }
...
//	private void doSave() {
//		String plant = getText();
//		try {
//			if(!Utils.isNull(plant)){
//				component.setProperty("fx8_Plant", plant);	
//			}else{
//				component.setProperty("fx8_Plant", null);	
//			}	
//		} catch (Exception e) {
//			e.printStackTrace();
//		}
...
//	}
    ...
    public static void setText(String plantStr) {
        if (propLov != null) {
            propLov.setSelectedItem(plantStr);
        }
    }
