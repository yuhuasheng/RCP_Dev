...
public class StandoffObjectNamePropertyBean extends AbstractPropertyBean<Object> {
    ...
    public StandoffObjectNamePropertyBean(Control paramControl) {
        super(paramControl);
    }

    public StandoffObjectNamePropertyBean(FormToolkit paramFormToolkit, Composite paramComposite, boolean paramBoolean,
                                          Map<?, ?> paramMap) {
        this.savable = true;
