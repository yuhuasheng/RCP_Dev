...
public class TxtPlacementDiffUtil {
	...
	public static String diffWithItemRevision(DataManagementService dmService, List<String> propertyList,
...
//				String refId = TCPublicUtils.getPropStr(dataManagementService, bomLine,BOMLinePropConstant.BL_REF_DESIGNATOR);
			...
			TCPublicUtils.refreshObject(dmService, itemRevision);
			String itemId = TCPublicUtils.getPropStr(dmService, itemRevision, ItemRevPropConstant.ITEM_ID);
			String version = TCPublicUtils.getPropStr(dmService, itemRevision, ItemRevPropConstant.ITEM_REVISION_ID);
			Date date = new Date();
//			SimpleDateFormat sdf = new SimpleDateFormat("HH.mm");
//			String fileName = itemId + "_" + sdf.format(date);
			String fileName = itemId + "_" + version + "_" + CommonTools.getNowTime2() + "_" + ConstantsEnum.DIFFERNAME.value();
			String filePath = TCMail.generateTxtFile(dir, fileName);
			List<String> contenList = new ArrayList<String>();
			if (CommonTools.isNotEmpty(diffList)) {
