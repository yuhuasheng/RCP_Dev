...
public class CreateObject {
	...
	public static TCComponentProcess createProcess(String workflowTemplateName, String processName, String desc,
			TCComponent[] att) {
		try {
			TCComponentTaskTemplateType templateType = (TCComponentTaskTemplateType) RACUIUtil.getTCSession()
			...
			TCComponentProcessType processType = (TCComponentProcessType) RACUIUtil.getTCSession().getTypeComponent("Job");
