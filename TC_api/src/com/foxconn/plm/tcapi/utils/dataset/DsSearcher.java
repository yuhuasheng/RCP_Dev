...
public class DsSearcher {
	 ...
	 private static Logger log=LogManager.getLogger(DsSearcher.class);
	 ...
	 */
	public String downloadDatasetByUrl(DataManagementService dmService, Dataset dataset, String dir, String fileName, String url) {
		InputStream inputStream = null;
		String downloadFilePath = null;
		Object obj = HttpUtil.httpGet(url); // 发送get请求返回文件流
		...
		if (obj instanceof InputStream) {
			...
			downloadFilePath = CommonTools.downloadFile(inputStream, dir, fileName);
		}
