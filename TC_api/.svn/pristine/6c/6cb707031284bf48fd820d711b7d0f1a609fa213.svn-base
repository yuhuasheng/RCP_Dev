...
public class EPMTaskService {	
	 ...
	 * @throws NotLoadedException
	 */
	public static String getTemplateTaskName(DataManagementService dataManagementService, EPMTask rootTask) throws NotLoadedException {	
		TCPublicUtils.refreshObject(dataManagementService, rootTask);
		return TCPublicUtils.getPropStr(dataManagementService, rootTask, EPMTaskPropConstant.OBJECT_NAME);			
	}
