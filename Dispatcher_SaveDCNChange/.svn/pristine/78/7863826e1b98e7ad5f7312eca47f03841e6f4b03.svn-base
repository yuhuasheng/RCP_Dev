package com.foxconn.savedcnchange.config;
...
public class TCSOAClientConfigImpl implements ITCSOAClientConfig {
	...
	private static final Logger log = LoggerFactory.getLogger(TCSOAClientConfigImpl.class);
	...
	@Override
	public void destroy() {
		log.info("【WARN】 destroy tc connection !!!");
		session.logout();
	}
